...
const REVIEW_LABEL_SINGULAR =
  "OpenClaw Security Scanner recorded an antivirus warning for a recent file action.";
const REVIEW_LABEL_PLURAL =
  "OpenClaw Security Scanner recorded antivirus warnings for recent file actions.";
